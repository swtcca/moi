...
const files = [
  "src/gun-vue/components/src/user/UserList.vue",
  "src/gun-vue/components/src/user/UserIcon.vue",
  "src/gun-vue/components/src/user/UserLogin.vue",
  "src/gun-vue/components/src/user/UserAuth.vue",
  "src/gun-vue/components/src/user/UserCreate.vue",
  "src/gun-vue/components/src/user/UserCredentials.vue",
  "src/gun-vue/components/src/user/UserPass.vue",
  "src/gun-vue/components/src/user/UserHome.vue",
  "src/gun-vue/components/src/user/UserProfile.vue",
  "src/gun-vue/components/src/user/UserRooms.vue",
  // "src/gun-vue/components/src/account/mate/AccountMateList.vue",
  "src/gun-vue/components/src/account/AccountReactions.vue",
  "src/gun-vue/components/src/account/AccountStars.vue",
  "src/gun-vue/components/src/chat/ChatInput.vue",
  "src/gun-vue/components/src/chat/ChatRoom.vue",
  "src/gun-vue/components/src/room/RoomFeature.vue",
  "src/gun-vue/components/src/room/RoomForm.vue",
  "src/gun-vue/components/src/room/RoomButton.vue",
  "src/gun-vue/components/src/room/RoomPage.vue",
  "src/gun-vue/components/src/room/RoomProfile.vue",
  "src/gun-vue/components/src/space/SpacePlane.vue",
  "src/gun-vue/components/src/util/UtilShare.vue",
  "src/gun-vue/components/src/util/UtilRelay.vue",
  "src/gun-vue/components/src/post/PostForm.vue",
  "src/gun-vue/components/src/post/PostList.vue",
  "src/gun-vue/components/src/post/PostPage.vue",
  // "src/gun-vue/components/src/post/feed/PostFeedList.vue",
  "src/gun-vue/components/src/form/FormText.vue",
  "src/gun-vue/components/src/form/FormYoutube.vue",
  "src/gun-vue/components/src/form/FormIpfs.vue",
  "src/gun-vue/components/src/form/FormLink.vue",
  "src/gun-vue/components/src/gift/GiftWallets.vue",
]
