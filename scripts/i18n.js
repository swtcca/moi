...
const files = [
  "src/gun-vue/components/user/UserList.vue",
  "src/gun-vue/components/user/UserIcon.vue",
  "src/gun-vue/components/user/UserLogin.vue",
  "src/gun-vue/components/user/UserAuth.vue",
  "src/gun-vue/components/user/UserCreate.vue",
  "src/gun-vue/components/user/UserCredentials.vue",
  "src/gun-vue/components/user/UserPass.vue",
  ...
  "src/gun-vue/components/util/UtilShare.vue",
  "src/gun-vue/components/util/UtilRelay.vue",
  "src/gun-vue/components/post/PostForm.vue",
  "src/gun-vue/components/post/PostList.vue",
  "src/gun-vue/components/post/PostPage.vue",
  // "src/gun-vue/components/post/feed/PostFeedList.vue",
  "src/gun-vue/components/form/FormText.vue",
