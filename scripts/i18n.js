...
const files = [
  ...
  'src/gun-vue/user/UserLogin.vue',
  'src/gun-vue/user/UserAuth.vue',
  'src/gun-vue/user/UserCreate.vue',
  'src/gun-vue/user/UserCredentials.vue',
  'src/gun-vue/user/UserPass.vue',
  'src/gun-vue/user/UserHome.vue',
  'src/gun-vue/user/UserProfile.vue',
  'src/gun-vue/user/UserRooms.vue',
  // "src/gun-vue/account/mate/AccountMateList.vue",
  'src/gun-vue/account/AccountReactions.vue',
  'src/gun-vue/account/AccountStars.vue',
  'src/gun-vue/chat/ChatInput.vue',
  'src/gun-vue/chat/ChatRoom.vue',
  'src/gun-vue/room/RoomFeature.vue',
  'src/gun-vue/room/RoomForm.vue',
  'src/gun-vue/room/RoomButton.vue',
  ...
  'src/gun-vue/util/UtilRelay.vue',
  'src/gun-vue/post/PostForm.vue',
  'src/gun-vue/post/PostList.vue',
  'src/gun-vue/post/PostPage.vue',
  // "src/gun-vue/post/feed/PostFeedList.vue",
  'src/gun-vue/form/FormText.vue',
  'src/gun-vue/form/FormYoutube.vue',
  // 'src/gun-vue/form/FormIpfs.vue',
...
async function replace_file(path, replaces = REPLACES) {
  if (!/\.js$|\.vue$|\.ts$/.test(path)) {
    ...
    const content_ori = fs.readFileSync(path, 'utf8').split('\n')
