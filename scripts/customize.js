...
const customize = {
  "./src/gun-vue/composables/src/gun/useGun.ts": { replaces: [
    [`import "gun/lib/webrtc"`, `import "gun/lib/open";\nimport "gun/lib/load";\nimport "gun/lib/webrtc"`]
  ]},
  "./src/gun-vue/composables/src/user/usePass.ts": { replaces: [
  ...
  "./src/gun-vue/composables/src/user/useUser.ts": { replaces: [
  ...
  "./src/gun-vue/components/src/post/PostCard.vue": { replaces: [
    [`.i-mdi-text-long.mx-1`, `.i-simple-icons-ipfs.mx-1(v-if="post?.ipfs")\n        .i-mdi-text-long.mx-1`],
  ]},
  "./src/gun-vue/components/src/post/PostLine.vue": { replaces: [
    [`.i-mdi-text-long`, `.i-simple-icons-ipfs(v-if="post?.ipfs")\n          .i-mdi-text-long`],
  ]},
  "./src/gun-vue/components/src/post/PostPage.vue": { replaces: [
  ...
  "./src/gun-vue/components/src/user/UserAvatar.vue": { replaces: [
  ...
  "./src/gun-vue/components/src/user/UserAuth.vue": { replaces: [
