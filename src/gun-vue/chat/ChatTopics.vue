...
transition(name="fade")
  .px-1.py-2.flex.flex-col.bg-dark-50.bg-opacity-95.gap-2.overflow-y-scroll.scroll-smooth.absolute.sm-static.z-20.w-220px.w-full.h-full.text-light-900.backdrop-filter.backdrop-blur-xl(v-if="isLarge || (panelOpen && !isLarge)" ref="chatsPanel" style="flex: 0 1 320px")
    .flex.flex-wrap
