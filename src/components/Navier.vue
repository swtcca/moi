...
<template>
  <nav ref="navier" class="flex flex-col items-center bg-light-300 dark-bg-dark-400">
    <div class="flex flex-wrap items-center gap-2 p-4">
      ...
      <router-link to="/files/" class="cursor-pointer flex-1 flex flex-col items-center p-4 relative dark-bg-dark-200 rounded-lg shadow-sm transition hover-shadow-lg">
        <div class="text-2xl">
