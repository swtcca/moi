...
.container.overflow-x-hidden
  ...
  .grid.grid-col.grid-cols-1.gap-2.min-w-xs.place-content-center.sm-px-2.sm-gap-4.md-px-4.md-gap-6.md-grid-cols-2.lg-gap-8.lg-grid-cols-3.xl-grid-cols-4.text-center(v-if="list_tokens")
